...
- **快捷查询**：无需切换当前应用，通过可配置全局快捷键完成主动单词查询和轻量问答；输入框提供词频与历史学习目标候选抽屉。
...
- **Windows 桌面体验**：支持系统托盘、单实例、隐藏启动、主窗口恢复、普通组合键与双击左 Alt 快捷键、开机启动与安全退出。
- **主题设置**：支持随包内置主题与浅/深色模式，并在多窗口之间保持一致。
